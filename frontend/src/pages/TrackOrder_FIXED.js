...
const TrackOrder = () => {
  ...
  // Check if map can be shown
  const canShowMap = location && 
    (location.customerLocation || location.restaurantLocation);

  // Compute map center SAFELY
  const mapCenter = location?.customerLocation
    ? [location.customerLocation.lat, location.customerLocation.lng]
    : location?.restaurantLocation
    ? [location.restaurantLocation.lat, location.restaurantLocation.lng]
    : null;
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        {/* Map - ONLY render when coordinates exist */}
        {canShowMap && mapCenter ? (
          <div className="h-64 rounded-lg overflow-hidden mb-4">
            ...
            >
              ...
              {location.deliveryLocation && (
                <Marker position={[location.deliveryLocation.lat, location.deliveryLocation.lng]}>
                  <Popup>
                    <div className="text-sm">
          ...
          <div className="h-64 flex items-center justify-center bg-gray-100 rounded-lg mb-4">
            <div className="text-center">
              ...
              <p className="text-gray-600">Waiting for live tracking...</p>
