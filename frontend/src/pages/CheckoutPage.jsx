  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <button
        ...
        disabled={loading}
        className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-4 rounded-lg w-full font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition"
      >
        {loading ? (
      ...
      {paymentMethod === "upi" && (
        <div className="text-center mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-900 font-medium">
            📱 You will be redirected to scan QR code or enter UPI ID
          </p>
