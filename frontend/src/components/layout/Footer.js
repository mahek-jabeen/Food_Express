    ...
    <footer className="bg-gray-800 text-white mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">FoodXpress</h3>
            <p className="text-gray-400">
              Food delivery marketplace bringing delicious meals to your doorstep.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link to="/partner" className="hover:text-white transition">Become a Partner</Link></li>
              <li><Link to="/restaurant-login" className="hover:text-white transition">Restaurant Login</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2026 FoodXpress. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
